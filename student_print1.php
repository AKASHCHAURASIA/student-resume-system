...
<div style="margin:2% 6%;"> 
	<div class="row" style="margin-bottom:20px">
		<div style="text-align:center">
			<p><span style="font-weight:bold;font-size:18px;"><?php echo $Name; ?></span><br>
			 Sangrur, Punjab |+91 <?php echo $MobileNo; ?><br>
			   <?php echo $Email; ?>
			</p>
		</div>
	...
	<div class="row row3">
        <div class="career-head1"><input class='c_row3' type='checkbox' name='ch' checked> Career Objective</div>
		<div class="career-body"><?php echo $Objective; ?></div>
        </div>
	<div class="row row4">
		<div >
        <div class="edu-head1"><input class='c_row4' type='checkbox' name='ch' checked> Educational Qualification</div>
		<table class="table table-bordered edutable" style="margin:20px 0">
			...
			<tbody>
			 <?php $SQL = "SELECT * FROM `educations qualification` WHERE u_id='".$uid."'  ORDER BY Year ASC ";
			 $res = mysqli_query($conn, $SQL);
		while ($db_field = mysqli_fetch_assoc($res))
		{
	...
	<div class="row row13">
        <div class="personal-head1"><input class='c_row13' type='checkbox' name='ch' checked> Personal Profile</div>
...
function PrintDiv() { 
            ...
            frameDoc.document.write('<style>.row{margin-left:  0px;margin-right: 0px;}</style></head><body>');
