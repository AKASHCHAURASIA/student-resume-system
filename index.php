...
if(isset($_SESSION['user'])){
	...
	$SQL = "SELECT * FROM users WHERE Username= '{$_SESSION['user']}'";
		...
		echo	$chk = $db_field['chk'];
				echo $db_post = $db_field['post'];
...
function logout($url,$data){
	$data="mode=193&username=$data&a=1502028051926&prototype=0";
    $fp = fopen("cookie.txt", "w");
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "cookie.txt");
...
$xml4[0]='Server is not response';
   ...
   if($xml4[0]=='You have successfully logged in.DO NOT SHARE YOUR CYBEROAM PASSWORD.CYBEROAM Password must meet complexity.' ||  $xml4[0]=='You have reached Maximum Login Limit. (Already Logged In Somewhere)' || $xml4[0]=='Your data transfer has been exceeded, Wait for Restoration of Your Limit (Next Day)')
	...
	if(mysqli_num_rows($res)>0)
	{
		...
		if($user == $db_user)
		{ 
	        $xml=logout("http://10.1.0.7:8090/logout.xml",$user);
			...
			{   
				...
				header("Location: sub-main.php");
							...
							{ 
                                ...
                                if($db_group == ''|| $db_branch == ''|| $db_batch ==''){
...
<body id="page-top" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="http://sliet.ac.in">Student Database System </a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
						<span class="skills">Proud To Be Part Of Team SLIET</span></br>
                        <span class="skills">Together We Can Make A Difference</span>
                    </div>
  ...
  <form class="login" method="POST" action="" style="display: inline-block">
    <p class="title " align="center">Student Database System</p>
