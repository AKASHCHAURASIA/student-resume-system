...
<div style="margin:2% 6%;"> 
	<div class="row row1" style="margin-bottom:20px">
		...
		<div style="width:40%;float:left;">
			<div class="img-div">
				<img src="./uploads/photo/<?php echo $user.".".$Photo; ?>" height=180 width=150 >
			</div>
		</div>
	</div>
	<div class="row row2">
    ...
    <div class="row5" style="border:1px solid black">
			...
			<?php $SQL = "SELECT * FROM `training` WHERE u_id='".$uid."'AND level='MBA/M. Tech.' ORDER BY sno ASC ";
				$res = mysqli_query($conn, $SQL);
				while ($db_field = mysqli_fetch_assoc($res))
				{
				...
				$SQL = "SELECT * FROM `training` WHERE u_id='".$uid."'AND level='BE' ORDER BY sno ASC ";
				$res = mysqli_query($conn, $SQL);
				while ($db_field = mysqli_fetch_assoc($res))
				{
				echo "<div class='industrial'>
				...
				$SQL = "SELECT * FROM `training` WHERE u_id='".$uid."'AND level='Diploma' ORDER BY sno ASC ";
				$res = mysqli_query($conn, $SQL);
				while ($db_field = mysqli_fetch_assoc($res))
				{
				echo "<div class='industrial'>
				...
				$SQL = "SELECT * FROM `training` WHERE u_id='".$uid."'AND level='Certificate'ORDER BY sno ASC ";
				$res = mysqli_query($conn, $SQL);
				while ($db_field = mysqli_fetch_assoc($res))
				{
				echo "<div class='industrial'>
		...
		<div class="row6" style="border:1px solid black;margin-top:10px">
				...
				<div class="row">
				<?php
				$SQL = "SELECT * FROM `projects` WHERE u_id='".$uid."' AND level='PG' ORDER BY sno ASC";
				$res = mysqli_query($conn, $SQL);
				...
				$SQL = "SELECT * FROM `projects` WHERE u_id='".$uid."' AND level='Degree' ORDER BY sno ASC";
				$res = mysqli_query($conn, $SQL);
				if(mysqli_num_rows($res))
				...
				$SQL = "SELECT * FROM `projects` WHERE u_id='".$uid."' AND level='Diploma' ORDER BY sno ASC";
				$res = mysqli_query($conn, $SQL);
				if(mysqli_num_rows($res))
