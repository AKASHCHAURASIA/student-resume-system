...
$res = mysqli_query($conn, "SELECT * FROM users WHERE Username='$del_user'");
		$db_field = mysqli_fetch_assoc($res);
			...
			if($flg==1)
			{
			if(mysqli_query($conn, "UPDATE users SET flag='0' WHERE Username='$del_user'") ){
				$msg = "PR removed sucessfully.";
				
			}
			else{
				$msg = "There was an error removing the student!";
			}
			}
			else{
				$msg="Student is not a PR.";
			}
	}
}
?>
            ...
            <div class="sidebar-collapse" >
                ...
                <ul class="nav" id="side-menu" style="background-color:#323232;">
					...
					<li class="list"><a   href='admin.php'><i class="fa fa-hand-pointer-o fa-fw"></i>home</a></li>
                     ...
                     <li class="list selected"><a   href='remove_pr.php'><i class="fa fa-hand-pointer-o fa-fw"></i>Remove PR</a></li>
           ...
           <div class="header">
			...
			<div  id="mainDiv" style="padding-top:15px; padding-bottom:15px;margin:2px 0;">
                ...
                <form action='' method='POST'>
                    <p style='font-size: 20px;'>Enter the username of the student you want to remove as PR!</p>
                    <tr>
                      <td>USERNAME</td>
                    ...
                    <tr>
                      <td></td>
                      <td><input type='submit' value='Remove' class='sub_btn stop' style='height: 25px; left: 10px; width: 80px;' name='submit'></td>
                    </tr>
                </form><br>
